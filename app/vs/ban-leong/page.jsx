      ...
      <section style={{ background: `linear-gradient(135deg, ${NAVY_DARK}, ${NAVY})`, padding: '72px 24px 64px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20, margin: '8px 0 32px' }}>
            ...
            <a href="https://banleong.com" target="_blank" rel="nofollow noopener noreferrer" style={{ background: WHITE, borderRadius: 12, padding: '10px 20px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', minWidth: 120, minHeight: 46 }}>
              <img src="https://banleong.com/wp-content/uploads/2025/09/BL-TECHNOLOGIES-PTE-LTD-LOGO_02-1.png" alt="Ban Leong Technologies" style={{ height: 26, width: 'auto', maxWidth: 130, display: 'block' }} />
            </a>
          </div>
