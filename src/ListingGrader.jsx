...
${notes ? `⚠ SELLER-PROVIDED PRODUCT DETAILS — YOU MUST include ALL of these in the rewritten title:
${notes}
Do NOT ignore any of the above. Each detail must appear in the rewritten title.` : ""}
